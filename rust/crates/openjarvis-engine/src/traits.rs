...
use OpenTron_core::{GenerateResult, Message, Role};
use serde_json::Value;
use std::pin::Pin;
use tokio_stream::Stream;

pub type StreamItem = Result<String, OpenTron_core::OpenTronError>;
...
pub trait InferenceEngine: Send + Sync {
    ...
    fn generate(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<GenerateResult, OpenTron_core::OpenTronError>;
    ...
    async fn stream(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<TokenStream, OpenTron_core::OpenTronError>;

    fn list_models(&self) -> Result<Vec<String>, OpenTron_core::OpenTronError>;
...
mod tests {
    use super::*;
    use OpenTron_core::{Message, ToolCall};
