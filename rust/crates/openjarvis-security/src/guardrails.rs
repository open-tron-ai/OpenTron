...
use OpenTron_core::error::OpenTronError;
use OpenTron_core::{EventBus, EventType, GenerateResult, Message};
use OpenTron_engine::traits::{InferenceEngine, TokenStream};
    ...
    fn handle_findings(
        ...
        match self.mode {
            ...
            RedactionMode::Block => {
                ...
                Err(OpenTronError::Security(
                    OpenTron_core::error::SecurityError::Blocked(format!(
...
mod tests {
    ...
    fn test_guardrails_block_mode() {
        ...
        let err = guardrails
            .generate(&[Message::user("Hi")], "mock", 0.7, 100, None)
            .unwrap_err();
        assert!(matches!(err, OpenTronError::Security(_)));
    }
}
