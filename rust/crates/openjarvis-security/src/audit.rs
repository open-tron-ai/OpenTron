...
use OpenTron_core::OpenTronError;
...
impl AuditLogger {
    ...
    pub fn log(&self, event: &SecurityEvent) -> Result<(), OpenTronError> {
    ...
    pub fn verify_chain(&self) -> Result<(bool, Option<i64>), OpenTronError> {
        let mut stmt = self
            .conn
            .prepare(
    ...
    pub fn query(
        ...
        since: Option<f64>,
        limit: usize,
    ) -> Result<Vec<SecurityEvent>, OpenTronError> {
