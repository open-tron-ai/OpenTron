...
mod tests {
    use super::*;
    use OpenTron_tools::builtin::calculator::CalculatorTool;

    fn make_server() -> McpServer {
        let mut exec = ToolExecutor::new(None, None);
        exec.register(OpenTron_tools::builtin::BuiltinTool::Calculator(CalculatorTool));
