...
impl PyMessage {
    pub fn to_core(&self) -> OpenTron_core::Message {
        let role = match self.role.as_str() {
            "system" => OpenTron_core::Role::System,
            "assistant" => OpenTron_core::Role::Assistant,
            "tool" => OpenTron_core::Role::Tool,
            _ => OpenTron_core::Role::User,
        };
        OpenTron_core::Message {
            role,
...
#[pyclass(name = "Config")]
pub struct PyConfig {
    pub inner: OpenTron_core::TronConfig,
}
...
impl PyConfig {
    ...
    fn new() -> Self {
        Self {
            inner: OpenTron_core::TronConfig::default(),
        }
    }
...
pub struct PyEventBus {
    pub inner: std::sync::Arc<OpenTron_core::EventBus>,
}
...
impl PyEventBus {
    ...
    fn new() -> Self {
        Self {
            inner: std::sync::Arc::new(OpenTron_core::EventBus::new(true)),
        }
    }
