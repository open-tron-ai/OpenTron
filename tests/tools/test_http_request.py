...
class TestHttpRequestTool:
    ...
    def test_ssrf_blocked_private_ip(self):
        ...
        tool = HttpRequestTool()
        with patch("OpenTron.tools.http_request.check_ssrf") as mock_ssrf:
    ...
    def test_successful_get(self):
        ...
        tool = HttpRequestTool()
        with patch("OpenTron.tools.http_request.check_ssrf", return_value=None):
    ...
    def test_redirect_to_private_ip_blocked(self):
        ...
        with patch(
            "OpenTron.tools.http_request.check_ssrf",
