...
from OpenTron.core import get_python_executable
from OpenTron.tools.shell_exec import ShellExecTool
...
class TestShellExecTool:
    def test_registered_via_tools_package_import(self):
        import OpenTron.tools as tools_pkg
        from OpenTron.core.registry import ToolRegistry

        sys.modules.pop("OpenTron.tools.shell_exec", None)
    ...
    def test_env_clearing(self):
        ...
        marker = "OpenTron_TEST_SECRET_12345"
    ...
    def test_env_passthrough(self):
        ...
        marker = "OpenTron_TEST_PASSTHROUGH_67890"
