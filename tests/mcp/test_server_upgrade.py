...
from OpenTron.mcp.protocol import MCPRequest
...
class TestServerTitle:
    def test_initialize_includes_title(self, server):
        ...
        assert server_info["title"] == "OpenTron Tool Server"
...
class TestStorageToolAnnotations:
    def test_memory_store_destructive(self):
        from OpenTron.tools.storage_tools import MemoryStoreTool
    ...
    def test_memory_retrieve_read_only(self):
        from OpenTron.tools.storage_tools import MemoryRetrieveTool
