...
_PATCH_HTTP = "OpenTron.mcp.transport.StreamableHTTPTransport"
_PATCH_STDIO = "OpenTron.mcp.transport.StdioTransport"
_PATCH_CLIENT = "OpenTron.mcp.client.MCPClient"
_PATCH_PROVIDER = "OpenTron.tools.mcp_adapter.MCPToolProvider"
_PATCH_LOGGER = "OpenTron.system.builder.logger"
