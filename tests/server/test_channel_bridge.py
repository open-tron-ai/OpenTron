...
from OpenTron.server.channel_bridge import ChannelBridge
from OpenTron.server.session_store import SessionStore
...
def mock_system():
    system = MagicMock()
    system.ask.return_value = {"content": "Hello from Tron!"}
    return system
