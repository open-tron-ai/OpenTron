...
from OpenTron.server.app import create_app  # noqa: E402
...
class TestChatCompletions:
    ...
    def test_instrumented_engine_unwrapped_to_avoid_dual_telemetry(self):
        ...
        from OpenTron.core.types import TOKEN_COUNTING_VERSION
    ...
    def test_streaming_with_tools_emits_tool_calls_and_bypasses_agent(self):
        ...
        from OpenTron.engine._stubs import StreamChunk
...
class TestIdentityPromptInjection:
    ...
    saw OpenTron's identity system prompt and the model answered from its
    ...
    def test_stream_injects_identity_when_absent(self):
        ...
        assert "OpenTron" in msgs[0].content
