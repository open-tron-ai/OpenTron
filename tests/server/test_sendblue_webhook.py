...
pytest.importorskip("fastapi", reason="OpenTron[server] not installed")

from fastapi import FastAPI  # noqa: E402
from starlette.testclient import TestClient  # noqa: E402

from OpenTron.core.registry import ChannelRegistry  # noqa: E402
...
def webhook_app(mock_bridge, sendblue_channel):
    from OpenTron.server.webhook_routes import create_webhook_router
...
class TestSendBlueHealth:
    ...
    def health_app(self, sendblue_channel):
        ...
        from OpenTron.server.agent_manager_routes import (
