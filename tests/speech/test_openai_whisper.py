...
from OpenTron.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_transcribe():
    ...
    with patch("OpenTron.speech.openai_whisper.OpenAI", return_value=mock_client):
        from OpenTron.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_health():
    with patch("OpenTron.speech.openai_whisper.OpenAI"):
        from OpenTron.speech.openai_whisper import OpenAIWhisperBackend
