...
from OpenTron.core.registry import TTSRegistry
from OpenTron.speech.tts import TTSResult
...
def test_cartesia_registered():
    from OpenTron.speech.cartesia_tts import CartesiaTTSBackend
...
def test_cartesia_synthesize():
    ...
    with patch(
        "OpenTron.speech.cartesia_tts._cartesia_synthesize",
...
def test_kokoro_registered():
    from OpenTron.speech.kokoro_tts import KokoroTTSBackend
...
def test_openai_tts_registered():
    from OpenTron.speech.openai_tts import OpenAITTSBackend
...
def test_openai_tts_synthesize():
    ...
    with patch(
        "OpenTron.speech.openai_tts._openai_tts_request",
