...
from OpenTron.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_transcribe():
    ...
    with patch("OpenTron.speech.deepgram.DeepgramClient", return_value=mock_client):
        from OpenTron.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_health():
    with patch("OpenTron.speech.deepgram.DeepgramClient"):
        from OpenTron.speech.deepgram import DeepgramSpeechBackend
