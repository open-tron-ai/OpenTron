...
from OpenTron.bench.energy import EnergyBenchmark
from OpenTron.core.registry import BenchmarkRegistry
from OpenTron.telemetry.energy_monitor import EnergySample


@pytest.fixture(autouse=True)
def _register_energy():
    """Re-register energy benchmark after registry clear."""
    from OpenTron.bench.energy import ensure_registered
