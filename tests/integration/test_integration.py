...
from OpenTron.core.registry import AgentRegistry, RouterPolicyRegistry, ToolRegistry
from OpenTron.core.types import (
    Conversation,
    Message,
    Role,
    TelemetryRecord,
...
def _register_agents():
    from OpenTron.agents.orchestrator import OrchestratorAgent
...
def _register_tools():
    from OpenTron.tools.calculator import CalculatorTool
    from OpenTron.tools.think import ThinkTool
...
class TestAPIServerRoundtrip:
    ...
    def test_roundtrip(self):
        ...
        from OpenTron.server.app import create_app
...
class TestTelemetryThroughAgent:
    ...
    def test_telemetry_record_created(self):
        ...
        from OpenTron.telemetry.instrumented_engine import InstrumentedEngine
...
class TestToolExecutorIntegration:
    ...
    def test_calculator_and_think(self):
        _register_tools()
        from OpenTron.tools._stubs import ToolExecutor
        from OpenTron.tools.calculator import CalculatorTool
        from OpenTron.tools.think import ThinkTool
...
class TestHeuristicRewardWithTelemetry:
    ...
    def test_reward_from_telemetry_record(self):
        from OpenTron.learning._stubs import RoutingContext
        from OpenTron.learning.routing.heuristic_reward import HeuristicRewardFunction
...
class TestRouterPolicyRegistryDiscovery:
    ...
    def test_both_policies_registered(self):
        from OpenTron.learning import ensure_registered
...
class TestTelemetryPipeline:
    ...
    def test_store_then_aggregate(self, tmp_path):
        ...
        from OpenTron.telemetry.aggregator import TelemetryAggregator
...
class TestAskFlowWithRouterPolicy:
    ...
    def test_mocked_ask_with_registry_router(self):
        from OpenTron.learning._stubs import RoutingContext
        from OpenTron.learning.routing.heuristic_policy import ensure_registered
        from OpenTron.learning.routing.router import HeuristicRouter
...
class TestSDKImport:
    """Verify Tron class is importable from OpenTron."""

    def test_Tron_imports(self):
...
class TestSDKAskFlow:
    ...
    def test_sdk_ask_e2e(self):
        ...
        from OpenTron.sdk import Tron

        engine = _make_engine("SDK response")
        with patch("OpenTron.sdk.get_engine", return_value=("mock", engine)):
            j = Tron(config=TronConfig(), model="test-model")
...
class TestSDKMemoryHandle:
    ...
    def test_index_and_search(self, tmp_path):
        from OpenTron.core.config import TronConfig
        from OpenTron.sdk import MemoryHandle
...
class TestBenchmarkRegistryDiscovery:
    ...
    def test_discovers_benchmarks(self):
        from OpenTron.bench import ensure_registered
        from OpenTron.core.registry import BenchmarkRegistry
...
class TestBenchmarkSuiteRunAll:
    ...
    def test_suite_produces_jsonl(self):
        ...
        from OpenTron.bench import ensure_registered
        from OpenTron.bench._stubs import BenchmarkSuite
        from OpenTron.core.registry import BenchmarkRegistry
...
class TestFullPipeline:
    ...
    def test_full_pipeline(self, tmp_path):
        ...
        from OpenTron.agents._stubs import AgentResult
        from OpenTron.core.config import TronConfig
        ...
        with patch("OpenTron.sdk.get_engine", return_value=("mock", engine)):
            j = Tron(config=cfg, model="test-model")
