...
class TestOpenHandsPipeline:
    ...
    def test_openhands_code_execution_e2e(self):
        _register_all()
        from OpenTron.agents.native_openhands import NativeOpenHandsAgent
        from OpenTron.tools.code_interpreter import (
            CodeInterpreterTool,
        )
...
class TestMCPIntegration:
    ...
    def test_mcp_server_with_all_tools(self):
        from OpenTron.mcp.client import MCPClient
        from OpenTron.mcp.server import MCPServer
        from OpenTron.mcp.transport import InProcessTransport
        from OpenTron.tools.calculator import CalculatorTool
        from OpenTron.tools.think import ThinkTool
    ...
    def test_mcp_unknown_tool_error(self):
        from OpenTron.mcp.client import MCPClient
        from OpenTron.mcp.protocol import MCPError
        from OpenTron.mcp.server import MCPServer
        from OpenTron.mcp.transport import InProcessTransport
        from OpenTron.tools.calculator import CalculatorTool
...
class TestMemoryPipeline:
    ...
    def test_bm25_index_and_retrieve(self, tmp_path):
        try:
            from OpenTron.tools.storage.bm25 import BM25Memory
        except ImportError:
...
class TestModelCatalogIntegration:
    ...
    def test_all_models_routable(self):
        ...
        from OpenTron.intelligence.model_catalog import (
            BUILTIN_MODELS,
        )
