...
class TestDetectHardware:
    ...
    @patch("OpenTron.core.config.shutil.which", return_value="/usr/bin/nvidia-smi")
    @patch(
        "OpenTron.core.config._run_cmd",
    ...
    @patch("OpenTron.core.config.shutil.which", return_value="/usr/bin/rocm-smi")
    @patch(
        "OpenTron.core.config._run_cmd",
        side_effect=[
    ...
    @patch("OpenTron.core.config.platform.system", return_value="Darwin")
    @patch(
        "OpenTron.core.config._run_cmd",
        return_value=(
            "Graphics/Displays:\n"
    ...
    @patch("OpenTron.core.config.shutil.which", return_value=None)
    @patch("OpenTron.core.config.platform.system", return_value="Linux")
