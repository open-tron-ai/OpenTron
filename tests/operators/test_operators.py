...
from OpenTron.operators.types import OperatorManifest
...
class TestOperatorLoader:
    def test_load_from_toml(self, tmp_path):
        from OpenTron.operators.loader import load_operator
...
class TestOperatorManager:
    def test_register(self):
        from OpenTron.operators.manager import OperatorManager
...
class TestOperativeAgent:
    def test_init_defaults(self):
        ...
        engine = FakeEngine()
        with patch(
            "OpenTron.agents._stubs.load_config",
    ...
    def test_run_tool_loop(self):
        from OpenTron.agents.operative import OperativeAgent
        from OpenTron.tools._stubs import BaseTool
...
class TestSystemAskPassthrough:
    def test_system_prompt_forwarded(self):
        ...
        from OpenTron.system import QueryOrchestrator

        with patch.object(QueryOrchestrator, "_run_agent", patched_run_agent):
            real_system = TronSystem(
...
class TestSchedulerOperatorExecution:
    def test_execute_task_with_operator_metadata(self):
        ...
        from OpenTron.scheduler.scheduler import ScheduledTask, TaskScheduler
...
class TestOperatorsConfig:
    def test_config_defaults(self):
        from OpenTron.core.config import OperatorsConfig
    ...
    def test_config_in_Tron_config(self):
        from OpenTron.core.config import TronConfig
...
class TestLoadBundledOperators:
    ...
    def operators_dir(self):
        ...
        ops_dir = project_root / "src" / "OpenTron" / "operators" / "data"
