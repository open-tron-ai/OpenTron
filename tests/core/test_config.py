...
class TestDefaults:
    def test_Tron_config_defaults(self) -> None:
        cfg = TronConfig()
...
class TestTomlLoading:
    def test_load_missing_file_uses_defaults(self, tmp_path: Path) -> None:
        ...
        assert isinstance(cfg, TronConfig)
    ...
    def test_system_prompt_block_parsed(self, tmp_path: Path) -> None:
        ...
        cfg = load_config(toml_file)
        assert cfg.system_prompt.prefix == "You are Tron."
...
class TestSecurityConfig:
    ...
    def test_security_config_on_Tron_config(self) -> None:
        cfg = TronConfig()
...
class TestChannelConfig:
    ...
    def test_channel_config_on_Tron_config(self) -> None:
        cfg = TronConfig()
...
class TestAgentConfigNew:
    ...
    def test_default_system_prompt_anchors_identity(self) -> None:
        """#540: the hardened wording must name OpenTron and explicitly
...
class TestSandboxConfig:
    def test_defaults(self) -> None:
        ...
        assert sc.image == "OpenTron-sandbox:latest"
    ...
    def test_on_Tron_config(self) -> None:
        cfg = TronConfig()
...
class TestApplyTomlSectionListNormalization:
    def test_apply_toml_section_list_to_str_field(self) -> None:
        ...
        from OpenTron.core.config import ToolsConfig, _apply_toml_section
    ...
    def test_apply_toml_section_list_to_property_setter(self) -> None:
        ...
        from OpenTron.core.config import _apply_toml_section
