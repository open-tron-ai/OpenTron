...
from OpenTron.core.config import LearningConfig, SkillsLearningConfig
from OpenTron.core.paths import get_config_dir
...
class TestSkillsLearningConfig:
    def test_defaults(self):
        ...
        # overlay_dir now resolves under the env-aware OpenTron root (#462),
