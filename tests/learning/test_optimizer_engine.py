"""Tests for OpenTron.optimize.optimizer module."""
...
from OpenTron.learning.optimize.optimizer import OptimizationEngine
from OpenTron.learning.optimize.store import OptimizationStore
from OpenTron.learning.optimize.types import (
    OptimizationRun,
    SearchDimension,
    SearchSpace,
    TrialConfig,
...
class TestLoadOptimizeConfig:
    ...
    def test_loads_toml_file(self, tmp_path) -> None:
        from OpenTron.learning.optimize.config import load_optimize_config
