...
from OpenTron.learning.optimize.trial_runner import (
    BenchmarkSpec,
...
class TestMultiBenchRunTrial:
    @patch("OpenTron.learning.optimize.trial_runner.TrialRunner.run_trial")
...
class TestLoadBenchmarkSpecs:
    def test_multi_benchmark_format(self):
        from OpenTron.learning.optimize.config import load_benchmark_specs
...
class TestParamToRecipe:
    def test_max_tokens_mapping(self):
        from OpenTron.learning.optimize.types import _PARAM_TO_RECIPE
