...
from OpenTron.learning.routing.learned_router import LearnedRouterPolicy
...
class TestLearnedRouterPolicy:
    def test_registered_as_learned(self) -> None:
        from OpenTron.core.registry import RouterPolicyRegistry
        from OpenTron.learning.routing.learned_router import ensure_registered
