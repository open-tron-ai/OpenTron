"""Smoke tests for ``Tron optimize`` and ``Tron feedback`` CLI commands,
...
class TestOptimizeConfig:
    """Tests for OptimizeConfig in TronConfig."""

    def test_optimize_config_in_Tron_config(self):
        from OpenTron.core.config import TronConfig, OptimizeConfig
    ...
    def test_optimize_config_defaults(self):
        from OpenTron.core.config import OptimizeConfig
...
class TestTraceStoreUpdateFeedback:
    ...
    def test_update_feedback_success(self, tmp_path):
        from OpenTron.core.types import Trace
