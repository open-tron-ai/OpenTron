"""Tests for OpenTron.optimize.trial_runner module."""

from __future__ import annotations

from unittest.mock import MagicMock, patch

from OpenTron.evals.core.types import RunConfig, RunSummary
from OpenTron.learning.optimize.trial_runner import TrialRunner
from OpenTron.learning.optimize.types import TrialConfig, TrialResult
...
class TestBuildRunConfig:
    ...
    def test_no_agent_maps_to_direct_backend(self) -> None:
        ...
        assert cfg.backend == "Tron-direct"
...
class TestRunTrial:
    ...
    @patch("OpenTron.evals.cli._build_scorer")
    @patch("OpenTron.evals.cli._build_judge_backend")
    @patch("OpenTron.evals.cli._build_dataset")
    @patch("OpenTron.evals.cli._build_backend")
    @patch("OpenTron.evals.core.runner.EvalRunner")
    ...
    def test_run_trial_populates_sample_scores(
        ...
        from OpenTron.evals.core.types import EvalResult
