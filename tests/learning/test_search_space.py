"""Tests for OpenTron.optimize.search_space module."""

from __future__ import annotations

from OpenTron.learning.optimize.search_space import (
    DEFAULT_SEARCH_SPACE,
    build_search_space,
)
from OpenTron.learning.optimize.types import SearchSpace
