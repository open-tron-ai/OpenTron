...
def connector(tmp_path: Path):
    ...
    from OpenTron.connectors.dropbox import DropboxConnector  # noqa: PLC0415
...
@patch("OpenTron.connectors.dropbox._dropbox_api_list_folder")
@patch("OpenTron.connectors.dropbox._dropbox_api_download")
