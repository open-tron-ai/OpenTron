...
def connector(tmp_path: Path):
    ...
    from OpenTron.connectors.gdrive import GDriveConnector  # noqa: PLC0415
...
@patch("OpenTron.connectors.gdrive._gdrive_api_list_files")
@patch("OpenTron.connectors.gdrive._gdrive_api_export")
