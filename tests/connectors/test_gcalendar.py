...
def connector(tmp_path: Path):
    ...
    from OpenTron.connectors.gcalendar import GCalendarConnector  # noqa: PLC0415

    creds_path = str(tmp_path / "gcalendar.json")
    with patch(
        "OpenTron.connectors.oauth._SHARED_GOOGLE_CREDENTIALS_PATH",
...
@patch("OpenTron.connectors.gcalendar._gcal_api_calendars_list")
@patch("OpenTron.connectors.gcalendar._gcal_api_events_list")
