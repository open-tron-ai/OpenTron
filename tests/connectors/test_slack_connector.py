...
from OpenTron.connectors._stubs import Document
from OpenTron.core.registry import ConnectorRegistry
...
def connector(tmp_path: Path):
    ...
    from OpenTron.connectors.slack_connector import SlackConnector  # noqa: PLC0415
...
@patch("OpenTron.connectors.slack_connector._slack_api_auth_test")
@patch("OpenTron.connectors.slack_connector._slack_api_conversations_list")
@patch("OpenTron.connectors.slack_connector._slack_api_conversations_history")
@patch("OpenTron.connectors.slack_connector._slack_api_users_list")
...
@patch("OpenTron.connectors.slack_connector._slack_api_with_retry")
def test_conversations_list_requests_all_conversation_types(mock_retry) -> None:
    ...
    """
    from OpenTron.connectors.slack_connector import (  # noqa: PLC0415
...
def test_end_to_end_ingest_and_search(
    ...
    """
    from OpenTron.connectors.hybrid_search import HybridSearch  # noqa: PLC0415
    from OpenTron.connectors.pipeline import IngestionPipeline  # noqa: PLC0415
    from OpenTron.connectors.store import KnowledgeStore  # noqa: PLC0415
    ...
    from OpenTron.agents.research_loop import _hit_url  # noqa: PLC0415
...
def test_sync_logs_per_type_channel_counts(
    ...
    with caplog.at_level("INFO", logger="OpenTron.connectors.slack_connector"):
        list(connector.sync())
...
def test_handle_callback_rejects_when_auth_test_fails(mock_auth, connector) -> None:
    ...
    from OpenTron.connectors.slack_connector import SlackTokenError  # noqa: PLC0415
