...
class TestOuraLive:
    def test_sync_returns_documents(self):
        from OpenTron.connectors.oura import OuraConnector
...
class TestStravaLive:
    def test_sync_returns_documents(self):
        from OpenTron.connectors.strava import StravaConnector
...
class TestSpotifyLive:
    def test_sync_returns_documents(self):
        from OpenTron.connectors.spotify import SpotifyConnector
...
class TestGoogleTasksLive:
    def test_sync_returns_documents(self):
        from OpenTron.connectors.google_tasks import GoogleTasksConnector
