...
_LOCAL_CONNECTORS = [
    ("apple_notes", "OpenTron.connectors.apple_notes", "AppleNotesConnector"),
    ("imessage", "OpenTron.connectors.imessage", "IMessageConnector"),
]

_TOKEN_CONNECTORS = [
    ("gmail_imap", "OpenTron.connectors.gmail_imap", "GmailIMAPConnector"),
    ("outlook", "OpenTron.connectors.outlook", "OutlookConnector"),
    ("slack", "OpenTron.connectors.slack_connector", "SlackConnector"),
    ("notion", "OpenTron.connectors.notion", "NotionConnector"),
    ("granola", "OpenTron.connectors.granola", "GranolaConnector"),
    ("gdrive", "OpenTron.connectors.gdrive", "GDriveConnector"),
    ("gcalendar", "OpenTron.connectors.gcalendar", "GCalendarConnector"),
    ("gcontacts", "OpenTron.connectors.gcontacts", "GContactsConnector"),
    ("dropbox", "OpenTron.connectors.dropbox", "DropboxConnector"),
]
...
def test_knowledge_store_has_data() -> None:
    ...
    """
    from OpenTron.connectors.store import KnowledgeStore
    from OpenTron.core.config import DEFAULT_CONFIG_DIR
