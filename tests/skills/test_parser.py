...
from OpenTron.skills.parser import SkillParseError, SkillParser
...
class TestTolerantFieldMapping:
    ...
    def test_metadata_OpenTron_namespace_used(self):
        parser = SkillParser()
        manifest = parser.parse_frontmatter(
            {
                "name": "test",
    ...
    def test_original_frontmatter_preserved(self):
        ...
        # Stored under metadata.OpenTron.original_frontmatter
