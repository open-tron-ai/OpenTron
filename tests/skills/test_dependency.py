...
class TestBuildDependencyGraph:
    def test_no_dependencies(self):
        from OpenTron.skills.dependency import build_dependency_graph
...
class TestValidateDependencies:
    def test_valid_topological_sort_simple(self):
        from OpenTron.skills.dependency import validate_dependencies
    ...
    def test_cycle_detection_raises(self):
        from OpenTron.skills.dependency import (
...
class TestComputeCapabilityUnion:
    def test_single_skill_no_deps(self):
        from OpenTron.skills.dependency import compute_capability_union
