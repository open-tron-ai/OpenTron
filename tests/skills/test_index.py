...
from OpenTron.skills.index import SkillIndex
...
class TestSkillIndex:
    def test_load_index(self, tmp_path: Path):
        ...
        index_file.write_text(
            ...
            author = "OpenTron"
            source = "github.com/OpenTron/skills/research"
            sha256 = "abc123"
            tags = ["research"]
    ...
    def test_search_by_name(self, tmp_path: Path):
        ...
        index_file.write_text(
            ...
            author = "OpenTron"
            source = "github.com/OpenTron/skills/web_research"
            sha256 = "abc"
            tags = ["research"]
            required_capabilities = []
            ...
            author = "OpenTron"
            source = "github.com/OpenTron/skills/code_review"
            sha256 = "def"
            tags = ["coding"]
            required_capabilities = []
        """)
