...
from OpenTron.learning.intelligence.orchestrator.grpo_trainer import (
    OrchestratorGRPOConfig,
)
from OpenTron.learning.intelligence.orchestrator.types import Episode
...
class TestRewardIntegration:
    def test_episode_reward(self):
        from OpenTron.learning.intelligence.orchestrator.reward import (
...
class TestGRPORegistration:
    def test_registered_in_learning_registry(self):
        import OpenTron.learning.intelligence.orchestrator.grpo_trainer  # noqa: F401
        from OpenTron.core.registry import LearningRegistry
