...
from OpenTron.agents.channel_agent import ChannelAgent
from OpenTron.agents.deep_research import DeepResearchAgent
...
from OpenTron.connectors.pipeline import IngestionPipeline
from OpenTron.connectors.retriever import TwoStageRetriever
from OpenTron.connectors.store import KnowledgeStore
from OpenTron.tools.knowledge_search import KnowledgeSearchTool
...
def test_quick_query_inline_response(tmp_path: Path) -> None:
    ...
    containing calendar info and NO OpenTron:// link.
    """
    ...
    assert "OpenTron://" not in sent_content, (
...
def test_deep_query_escalation_link(tmp_path: Path) -> None:
    ...
    assert "OpenTron://" in sent_content, (
