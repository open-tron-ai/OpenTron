"""Persona files reach persistent agents, not just one-shot `Tron ask` (#376).

SOUL.md / MEMORY.md / USER.md are loaded by `Tron ask` via SystemPromptBuilder.
...
from OpenTron.core.config import MemoryFilesConfig, SystemPromptConfig
from OpenTron.prompt.builder import SystemPromptBuilder
