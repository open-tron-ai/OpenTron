...
from OpenTron.system import TronSystem, SystemBuilder


class TestTronSystem:
...
class TestSystemBuilder:
    ...
    def test_builder_default_config(self):
        ...
        assert isinstance(builder._config, TronConfig)
...
class TestSystemBuilderEngineInstance:
    """Explicit engine injection (Tron eval --base-url path)."""
    ...
    def test_engine_instance_is_fluent(self):
        builder = SystemBuilder(TronConfig())
    ...
    def test_unhealthy_injected_instance_never_consults_discovery(self):
        ...
        with patch("OpenTron.engine._discovery.get_engine") as mock_get_engine:
