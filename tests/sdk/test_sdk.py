"""Tests for the Python SDK — Tron class and MemoryHandle."""
...
from OpenTron.sdk import Tron, MemoryHandle
...
class TestTronInit:
    ...
    def test_version_property(self):
        j = Tron(config=TronConfig())
        assert j.version == OpenTron.__version__
        j.close()

    def test_engine_key_override(self):
        j = Tron(config=TronConfig(), engine_key="custom")
        assert j._engine_key == "custom"
        j.close()

    def test_model_override(self):
        j = Tron(config=TronConfig(), model="my-model")
...
class TestTronAsk:
    ...
    def test_ask_no_engine_raises(self):
        with patch("OpenTron.sdk.get_engine", return_value=None):
            j = Tron(config=TronConfig())
