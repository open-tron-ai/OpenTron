"""Tests for model resolution fallback chain in Tron ask."""
...
def _register_agents():
    ...
    The default ``TronConfig().agent.default_agent`` is ``"simple"``,
    so ``Tron ask "..."`` (without ``--agent``) routes through SimpleAgent.
