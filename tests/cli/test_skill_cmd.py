"""Tests for the ``Tron skill`` CLI commands."""
...
class TestSkillCmd:
    ...
    def test_skill_list_shows_discovered_skills(self, tmp_path: Path) -> None:
        ...
        with patch(
            "OpenTron.cli.skill_cmd._get_skill_paths",
...
class TestSkillSearchCommand:
    ...
    def test_search_no_sources_configured(self) -> None:
        from OpenTron.core.config import TronConfig, SkillsConfig

        cfg = TronConfig()
        cfg.skills = SkillsConfig(sources=[])
        with patch("OpenTron.cli.skill_cmd.load_config", return_value=cfg):
    ...
    def test_search_filters_results(self) -> None:
        ...
        from OpenTron.skills.sources.base import ResolvedSkill
        ...
        with patch("OpenTron.cli.skill_cmd.load_config", return_value=cfg):
            with patch(
                "OpenTron.cli.skill_cmd._get_resolver",
...
class TestSkillDiscoverCommand:
    ...
    def test_discover_dry_run_no_traces(self, tmp_path: Path) -> None:
        ...
        with patch(
            "OpenTron.cli.skill_cmd._get_trace_store",
    ...
    def test_discover_writes_when_not_dry_run(self, tmp_path: Path) -> None:
        ...
        from OpenTron.core.types import StepType, Trace, TraceStep
        ...
        with patch(
            ...
            with patch(
                "OpenTron.cli.skill_cmd._get_discovered_dir",
...
class TestSkillShowOverlayCommand:
    ...
    def test_show_overlay_missing(self, tmp_path: Path) -> None:
        ...
        with patch(
            "OpenTron.cli.skill_cmd._get_overlay_dir",
    ...
    def test_show_overlay_displays_optimized(self, tmp_path: Path) -> None:
        ...
        from OpenTron.skills.overlay import SkillOverlay, write_overlay
