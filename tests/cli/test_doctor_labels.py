"""Tests for ``Tron doctor`` optional dependency labels."""
...
class TestDoctorOptionalLabels:
    ...
    def test_labels_show_install_hint_on_missing(self) -> None:
        ...
        assert "Not installed (OpenTron[energy-apple])" == apple_checks[0]["message"]
    ...
    def test_nvidia_label_uses_current_extra_name(self) -> None:
        ...
        assert "Not installed (OpenTron[gpu-metrics])" == nvidia_checks[0]["message"]
