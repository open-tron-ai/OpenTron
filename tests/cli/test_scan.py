"""Tests for ``Tron scan`` privacy scanner CLI command."""
...
from OpenTron.cli.scan_cmd import PrivacyScanner, ScanResult
...
class TestJsonOutput:
    ...
    def test_json_output_structure(self) -> None:
        ...
        from OpenTron.cli.scan_cmd import scan

        runner = CliRunner()
        with patch(
            "OpenTron.cli.scan_cmd.PrivacyScanner.run_all",
            return_value=[
