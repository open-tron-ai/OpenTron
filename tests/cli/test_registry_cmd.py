"""Tests for the ``Tron registry`` CLI commands."""
...
class TestRegistryCmd:
    """Test cases for the Tron registry CLI group."""
    ...
    def test_registry_show_handles_exception(self) -> None:
        ...
        with patch(
            "OpenTron.core.registry.ToolRegistry.keys",
    ...
    def test_registry_show_handles_error_during_import(self) -> None:
        ...
        with patch.dict("sys.modules", {"OpenTron.core.registry": None}):
