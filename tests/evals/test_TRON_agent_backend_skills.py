"""Tests for TronAgentBackend skills_enabled / overlay_dir kwargs (Plan 2B)."""
...
class TestTronAgentBackendSkillsKwargs:
    ...
    def test_init_signature_accepts_kwargs_without_engine(self):
        ...
        sig = inspect.signature(TronAgentBackend.__init__)
