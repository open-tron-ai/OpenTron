...
from OpenTron.evals.datasets.lifelong_agent import LifelongAgentDataset
from OpenTron.evals.scorers.lifelong_agent_scorer import (
    LifelongAgentScorer,
...
class TestDBEnvironment:
    def test_multi_turn_select(self) -> None:
        ...
        from OpenTron.evals.environments.lifelong_agent_env import DBEnvironment
...
class TestKGEnvironment:
    def test_multi_turn_with_oracle(self) -> None:
        ...
        from OpenTron.evals.environments.lifelong_agent_env import KGEnvironment
...
class TestOSEnvironment:
    def test_requires_docker(self) -> None:
        ...
        from OpenTron.evals.environments.lifelong_agent_env import OSEnvironment
...
class TestCLI:
    def test_in_benchmarks(self) -> None:
        from OpenTron.evals.cli import BENCHMARKS
...
class TestRunnerEpisodeMode:
    def test_episode_mode_field_exists(self) -> None:
        from OpenTron.evals.core.types import RunConfig
    ...
    def test_runner_has_episode_mode_method(self) -> None:
        from OpenTron.evals.core.runner import EvalRunner
...
class TestMaxTurns:
    def test_db_max_turns(self) -> None:
        from OpenTron.evals.environments.lifelong_agent_env import (
            MAX_TURNS_DB,
            DBEnvironment,
        )
    ...
    def test_base_default(self) -> None:
        from OpenTron.evals.environments.base import TaskEnvironment
