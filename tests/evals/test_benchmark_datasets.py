...
class TestDatasetInstantiation:
    ...
    def test_supergpqa(self) -> None:
        from OpenTron.evals.datasets.supergpqa import SuperGPQADataset
    ...
    def test_gpqa(self) -> None:
        from OpenTron.evals.datasets.gpqa import GPQADataset
    ...
    def test_mmlu_pro(self) -> None:
        from OpenTron.evals.datasets.mmlu_pro import MMLUProDataset
    ...
    def test_math500(self) -> None:
        from OpenTron.evals.datasets.math500 import MATH500Dataset
    ...
    def test_natural_reasoning(self) -> None:
        from OpenTron.evals.datasets.natural_reasoning import NaturalReasoningDataset
    ...
    def test_hle(self) -> None:
        from OpenTron.evals.datasets.hle import HLEDataset
    ...
    def test_simpleqa(self) -> None:
        from OpenTron.evals.datasets.simpleqa import SimpleQADataset
    ...
    def test_wildchat(self) -> None:
        from OpenTron.evals.datasets.wildchat import WildChatDataset
    ...
    def test_ipw(self) -> None:
        from OpenTron.evals.datasets.ipw_mixed import IPWDataset
    ...
    def test_gaia(self) -> None:
        from OpenTron.evals.datasets.gaia import GAIADataset
    ...
    def test_frames(self) -> None:
        from OpenTron.evals.datasets.frames import FRAMESDataset
    ...
    def test_swebench(self) -> None:
        from OpenTron.evals.datasets.swebench import SWEBenchDataset
    ...
    def test_swefficiency(self) -> None:
        from OpenTron.evals.datasets.swefficiency import SWEfficiencyDataset
    ...
    def test_terminalbench(self) -> None:
        from OpenTron.evals.datasets.terminalbench import TerminalBenchDataset
    ...
    def test_terminalbench_native(self) -> None:
        from OpenTron.evals.datasets.terminalbench_native import (
    ...
    def test_terminalbench_v2_1(self) -> None:
        from OpenTron.evals.datasets.terminalbench_v2_1 import (
    ...
    def test_livecodebench(self) -> None:
        from OpenTron.evals.datasets.livecodebench import LiveCodeBenchDataset
    ...
    def test_deepresearch(self) -> None:
        from OpenTron.evals.datasets.liveresearch import LiveResearchBenchDataset
    ...
    def test_toolcall15(self) -> None:
        from OpenTron.evals.datasets.toolcall15 import ToolCall15Dataset
...
class TestScorerInstantiation:
    ...
    def test_terminalbench_scorer(self) -> None:
        from OpenTron.evals.scorers.terminalbench_judge import TerminalBenchScorer
    ...
    def test_terminalbench_native_scorer(self) -> None:
        from OpenTron.evals.scorers.terminalbench_native_structural import (
    ...
    def test_terminalbench_v2_1_scorer(self) -> None:
        from OpenTron.evals.scorers.terminalbench_v2_1 import (
...
class TestCLIFactories:
    ...
    def test_build_dataset(self, benchmark: str) -> None:
        from OpenTron.evals.cli import _build_dataset
    ...
    def test_build_scorer(self, benchmark: str) -> None:
        from OpenTron.evals.cli import _build_scorer
...
class TestConfigBenchmarks:
    ...
    def test_all_benchmarks_known(self) -> None:
        from OpenTron.evals.core.config import KNOWN_BENCHMARKS
...
class TestStructuralScorers:
    ...
    def test_swebench_empty_response(self) -> None:
        from OpenTron.evals.core.types import EvalRecord
        from OpenTron.evals.scorers.swebench_structural import SWEBenchScorer
