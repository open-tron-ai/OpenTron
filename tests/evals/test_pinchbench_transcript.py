...
from OpenTron.evals.core.event_recorder import AgentEvent, EventType
from OpenTron.evals.core.trace import TurnTrace
...
def test_events_to_transcript_tool_call_pair():
    ...
    from OpenTron.evals.scorers.pinchbench import events_to_transcript
...
def test_events_to_transcript_tool_name_mapping():
    """OpenTron tool names are mapped to PinchBench-expected names."""
    from OpenTron.evals.scorers.pinchbench import events_to_transcript
