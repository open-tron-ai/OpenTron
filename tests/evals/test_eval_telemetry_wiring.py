...
- TronDirectBackend propagates gpu_metrics flag
...
from OpenTron.evals.core.types import EvalResult, RunConfig, RunSummary
...
class TestSummaryToDict:
    ...
    def test_telemetry_summary_present(self):
        from OpenTron.evals.core.runner import _summary_to_dict
...
class TestResultToTraceDict:
    ...
    def test_estimated_flops_in_trace(self):
        from OpenTron.evals.core.runner import _result_to_trace_dict
...
# ---------------------------------------------------------------------------
# TronDirectBackend gpu_metrics propagation
# ---------------------------------------------------------------------------


class TestDirectBackendGpuMetrics:
    """Verify TronDirectBackend sets gpu_metrics on config."""

    @patch("OpenTron.system.SystemBuilder")
    def test_gpu_metrics_propagated(self, mock_builder_cls):
        """When gpu_metrics=True, the builder config should be updated."""
        from OpenTron.evals.backends.Tron_direct import TronDirectBackend
...
class TestTauBenchTelemetryPassthrough:
    ...
    def test_set_engine_config_stores_flags(self):
        ...
        from OpenTron.evals.datasets.taubench import TauBenchDataset
    ...
    @patch("OpenTron.evals.execution.taubench_env.TauBenchTaskEnv")
...
class TestExpandSuiteModelMetadata:
    ...
    def test_metadata_includes_params(self):
        from OpenTron.evals.core.config import expand_suite
        from OpenTron.evals.core.types import (
            BenchmarkConfig,
            DefaultsConfig,
            EvalSuiteConfig,
            ExecutionConfig,
