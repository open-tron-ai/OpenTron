...
from OpenTron.evals.cli import BACKENDS, _build_backend
...
class TestBuildBackendDispatch:
    def test_backends_dict_includes_external(self) -> None:
        ...
        assert "Tron-agent" in BACKENDS
        assert "Tron-direct" in BACKENDS
    ...
    def test_hermes_returns_hermes_backend(self) -> None:
        ...
        with (
            ...
            patch("OpenTron.evals.backends.external.hermes_agent.verify_commit_pin"),
        ):
            from OpenTron.evals.backends.external import HermesBackend
