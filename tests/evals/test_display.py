"""Tests for the Rich display helpers in OpenTron.evals.core.display."""
...
from OpenTron.evals.core.display import (
    print_banner,
    print_completion,
    print_metrics_table,
    print_run_header,
...
from OpenTron.evals.core.types import MetricStats, RunSummary
...
class TestPrintBanner:
    def test_produces_output(self):
        ...
        output = buf.getvalue()
        assert "OpenTron" in output or "___" in output
