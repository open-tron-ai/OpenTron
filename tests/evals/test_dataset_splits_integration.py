...
PROVIDERS = [
    ("OpenTron.evals.datasets.pinchbench", "PinchBenchDataset"),
    ("OpenTron.evals.datasets.liveresearch", "LiveResearchBenchDataset"),
    ("OpenTron.evals.datasets.gaia", "GAIADataset"),
    ("OpenTron.evals.datasets.liveresearchbench", "LiveResearchBenchDataset"),
    ("OpenTron.evals.datasets.taubench", "TauBenchDataset"),
    ("OpenTron.evals.datasets.toolcall15", "ToolCall15Dataset"),
    ("OpenTron.evals.datasets.livecodebench", "LiveCodeBenchDataset"),
]
