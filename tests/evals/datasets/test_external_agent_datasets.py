...
PROVIDERS = [
    ("OpenTron.evals.datasets.adp", "ADPDataset"),
    ("OpenTron.evals.datasets.toolorchestra", "ToolOrchestraDataset"),
    ("OpenTron.evals.datasets.generalthoughts", "GeneralThoughtsDataset"),
]
