...
from OpenTron.evals.datasets.ama_bench import AMABenchDataset
from OpenTron.evals.scorers.ama_bench_judge import (
    AMABenchScorer,
    _compute_token_f1,
    _parse_judge_label,
)
...
class TestAMABenchDataset:
    ...
    def test_question_types_mapped(self) -> None:
        from OpenTron.evals.datasets.ama_bench import _QUESTION_TYPE_TO_SUBJECT
