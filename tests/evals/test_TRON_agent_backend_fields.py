"""Verify TronAgentBackend.generate_full returns the spec §6.2 extended fields."""
...
class TestTronAgentExtendedFields:
    def test_generate_full_includes_framework_and_commit(self) -> None:
        from OpenTron.evals.backends.Tron_agent import TronAgentBackend

        with patch("OpenTron.system.SystemBuilder") as MockSB:
            ...
            backend = TronAgentBackend(model="qwen-9b")
