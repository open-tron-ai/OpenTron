...
- **Persistence:** SQLite database file (default: `~/.OpenTron/memory.db`)
...
!!! note "Backward compatibility"
    The old `from OpenTron.memory.bm25 import BM25Memory` still works via backward-compatibility shims, but new code should use the canonical `OpenTron.tools.storage.*` imports.
...
from OpenTron.tools.storage.chunking import ChunkConfig
...
[Source: docs/intro.md] OpenTron is a modular AI framework...
...
Tron memory index ./notes/ --chunk-size 256 --chunk-overlap 32
