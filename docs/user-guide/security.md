...
OpenTron includes a security layer that scans prompts and model outputs for secrets, personally identifiable information (PII), and sensitive file paths. The system is designed to be composable: scanners run as a pipeline, and the `GuardrailsEngine` wrapper drops in front of any inference backend without changing how the rest of your code works.
...
=== "Warn mode (default)"
    ...
    from OpenTron.engine.ollama import OllamaEngine
    from OpenTron.security.guardrails import GuardrailsEngine
    from OpenTron.security.types import RedactionMode
    from OpenTron.core.types import Message, Role
...
=== "Block mode"
    ...
    from OpenTron.engine.ollama import OllamaEngine
    from OpenTron.security.guardrails import GuardrailsEngine, SecurityBlockError
    from OpenTron.security.types import RedactionMode
    from OpenTron.core.types import Message, Role
...
from OpenTron.security.guardrails import GuardrailsEngine
from OpenTron.security.scanner import SecretScanner
from OpenTron.security.types import RedactionMode
...
from OpenTron.security.scanner import PIIScanner
...
from OpenTron.security.file_policy import is_sensitive_file, filter_sensitive_paths
...
from OpenTron.security.audit import AuditLogger
from OpenTron.security.guardrails import GuardrailsEngine
from OpenTron.security.types import RedactionMode
from OpenTron.engine.ollama import OllamaEngine
...
audit = AuditLogger(db_path="~/.OpenTron/audit.db", bus=bus)
...
import time
from OpenTron.security.audit import AuditLogger
from OpenTron.security.types import SecurityEvent, SecurityEventType
...
audit = AuditLogger(db_path="~/.OpenTron/audit.db")
...
Security settings live in the `[security]` section of `~/.OpenTron/config.toml`.
...
secret_scanner = true
pii_scanner = true
audit_log_path = "~/.OpenTron/audit.db"
...
| `audit_log_path` | `str` | `~/.OpenTron/audit.db` | Path to the SQLite audit log |
...
import re
from OpenTron.security._stubs import BaseScanner
from OpenTron.security.types import ScanFinding, ScanResult, ThreatLevel
...
- [API Reference: Security](../api-reference/OpenTron/security/index.md) — full class and function signatures
