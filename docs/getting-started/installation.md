---
title: Installation
description: Get OpenTron running — browser app, desktop app, CLI, or Python SDK
search:
  boost: 3
---
...
=== "Step 1: Clone and install"
    ...
    uv run maturin develop -m rust/crates/OpenTron-python/Cargo.toml
...
The desktop app is a native window for the OpenTron chat UI. All inference and backend
...
| Platform | Download |
|----------|----------|
| macOS (Universal) | [:material-download: **OpenTron.dmg**](https://github.com/open-Tron/OpenTron/releases/download/desktop-v1.0.2/OpenTron_1.0.1_universal.dmg) |
| Windows (64-bit) | [:material-download: **OpenTron-setup.exe**](https://github.com/open-Tron/OpenTron/releases/download/desktop-v1.0.2/OpenTron_1.0.1_x64-setup.exe) |
| Linux (DEB) | [:material-download: **OpenTron.deb**](https://github.com/open-Tron/OpenTron/releases/download/desktop-v1.0.2/OpenTron_1.0.1_amd64.deb) |
| Linux (RPM) | [:material-download: **OpenTron.rpm**](https://github.com/open-Tron/OpenTron/releases/download/desktop-v1.0.2/OpenTron-1.0.1-1.x86_64.rpm) |
| Linux (AppImage) | [:material-download: **OpenTron.AppImage**](https://github.com/open-Tron/OpenTron/releases/download/desktop-v1.0.2/OpenTron_1.0.1_amd64.AppImage) |
...
!!! warning "macOS: \"app is damaged\""
    ...
    ```bash
    xattr -cr /Applications/OpenTron.app
    ```
    This is normal for open-source apps distributed outside the App Store.

!!! tip "All releases"
    Browse all versions on the [GitHub Releases](https://github.com/open-Tron/OpenTron/releases) page.
...
The command-line interface is the fastest way to interact with OpenTron
...
Tron ask --agent orchestrator --tools calculator "What is 137 * 42?"
...
For programmatic access, the `Tron` class provides a high-level sync API.
...
```python
from OpenTron import SystemBuilder
...
OpenTron uses optional extras to keep the base installation lightweight.
...
!!! note "Ollama, vLLM, and llama.cpp are HTTP-based"
    These engines have no additional Python dependencies — OpenTron communicates over HTTP. You still need the engine software running on your machine.
...
| `server` | `uv sync --extra server` | OpenAI-compatible API server (`Tron serve`) |
...
OpenTron requires at least one inference backend. Choose the one that matches your hardware.
