...
Serves the installers at::
    ...
    https://open-Tron.github.io/OpenTron/install.sh   (Linux / macOS / WSL2)
    https://open-Tron.github.io/OpenTron/install.ps1  (native Windows)

so users have an HTTPS-valid, project-controlled install URL that does not
depend on the externally-hosted ``OpenTron.ai`` domain — whose TLS config
