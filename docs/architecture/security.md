...
The default path is `~/.OpenTron/audit.db`, configurable via `security.audit_log_path` in `config.toml`.
...
- [API Reference: Security](../api-reference/OpenTron/security/index.md) — complete class and function signatures
