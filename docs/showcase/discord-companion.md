...
description: Tron answers questions in your private Discord while you sleep — reads your notes, checks your calendar, schedules things
---

# 💬 Discord Companion — a personal assistant that lives in my Discord

<figure markdown>
  ![Tron answering a Discord DM about the user's calendar and notes](../assets/showcase/discord-companion.png){ .showcase-screenshot loading=lazy }
  <figcaption>I DM'd Tron from my phone at midnight. It checked my Google Calendar, cross-referenced a note from last week, and answered — running on the Mac mini in my closet.</figcaption>
</figure>

I have a private Discord server with two channels and one user (me). Tron lives there. I can DM it from my phone, my laptop, or my watch — anywhere Discord runs. Sample things I've asked it this week:

- "What's the address of the place I had that meeting last Tuesday?" → Tron searches my calendar + meeting notes, replies in 4 seconds.
...
I used to use my phone's voice assistant for this. The two differences that matter: **Tron answers in three sentences, not one,** and **it actually has my context** — my notes, my calendar, my projects, my history.
...
→ **[MCP integration guide](../user-guide/cli.md)** if you want Tron to reach into Notion, Linear, Gmail, etc.
