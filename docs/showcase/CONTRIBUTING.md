...
description: How to add your setup to the OpenTron Showcase
---

# Contributing a Showcase Entry

The Showcase exists for one reason: to help a confused, curious, *non-technical* reader figure out whether OpenTron is worth their weekend. That goal sets every editorial choice on this page.
...
→ **[Recipe: <name>](https://github.com/open-Tron/OpenTron/tree/main/src/OpenTron/recipes/data)** if you want the exact config.
...
✅ "Tron answers my Discord messages while I sleep."
...
Hannah and the docs team post merged showcase entries to **`#config-showcase`** in [the OpenTron Discord](https://discord.gg/OpenTron). You'll get tagged in the post — you don't have to do it yourself.
