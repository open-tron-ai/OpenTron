---
title: Downloads
description: Download the OpenTron desktop app, browser app, CLI, or Python SDK
---
...
!!! info "Backend required"
    ...
    ```bash
    git clone https://github.com/open-Tron/OpenTron.git && cd OpenTron
...
|----------|----------|-------|
| macOS (Universal) | [:material-download: **OpenTron.dmg**](https://github.com/open-Tron/OpenTron/releases/download/desktop-v1.0.2/OpenTron_1.0.1_universal.dmg) | Apple Silicon + Intel |
| Windows (64-bit) | [:material-download: **OpenTron-setup.exe**](https://github.com/open-Tron/OpenTron/releases/download/desktop-v1.0.2/OpenTron_1.0.1_x64-setup.exe) | Windows 10+ |
| Linux (DEB) | [:material-download: **OpenTron.deb**](https://github.com/open-Tron/OpenTron/releases/download/desktop-v1.0.2/OpenTron_1.0.1_amd64.deb) | Ubuntu, Debian |
| Linux (RPM) | [:material-download: **OpenTron.rpm**](https://github.com/open-Tron/OpenTron/releases/download/desktop-v1.0.2/OpenTron-1.0.1-1.x86_64.rpm) | Fedora, RHEL |
| Linux (AppImage) | [:material-download: **OpenTron.AppImage**](https://github.com/open-Tron/OpenTron/releases/download/desktop-v1.0.2/OpenTron_1.0.1_amd64.AppImage) | Any distro |
...
by Apple. If you see **"OpenTron is damaged and can't be opened"**, run this in
...
```bash
xattr -cr ~/Downloads/OpenTron.app
```
