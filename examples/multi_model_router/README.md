...
Route queries to the cheapest capable model using OpenTron's learning/routing
...
The script uses OpenTron's routing infrastructure from the learning pillar:
