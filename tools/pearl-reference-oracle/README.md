# Pearl reference oracle (OpenTron Phase 0 deliverable)
...
If it succeeds, this host can mine Pearl using the OpenTron `cpu-pearl` provider
...
- When Pearl bumps `py-pearl-mining` API: re-run the smoke test against the
  new ref pinned in `OpenTron/src/OpenTron/mining/_constants.py`.
