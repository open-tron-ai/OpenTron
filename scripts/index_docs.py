#!/usr/bin/env python3
"""Index OpenTron docs (README.md + docs/**/*.md) into a DenseMemory backend.
...
def build_index(
    ...
    *,
    ...
    dedupe: bool = True,
    # Empirical: on the actual OpenTron docs the boilerplate that
    # crowds retrieval ("OpenTron runs entirely on your hardware...")
...
def main() -> int:
    ...
    queries = args.query or [
        ...
        "what inference engines does OpenTron support?",
