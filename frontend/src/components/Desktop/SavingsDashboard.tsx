...
const OPTIN_KEY = 'OpenTron-desktop-optin';
const OPTIN_NAME_KEY = 'OpenTron-desktop-display-name';
const OPTIN_EMAIL_KEY = 'OpenTron-desktop-email';
const OPTIN_ANONID_KEY = 'OpenTron-desktop-anon-id';
    ...
    <div style={styles.container}>
      ...
      {showOptIn ? (
        ...
        <div style={{ marginBottom: 16, display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <a
            href="https://open-Tron.github.io/OpenTron/leaderboard"
            target="_blank"
