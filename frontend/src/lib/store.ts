...
const CONVERSATIONS_KEY = 'OpenTron-conversations';
const SETTINGS_KEY = 'OpenTron-settings';
const OPTIN_KEY = 'OpenTron-optin';
const OPTIN_NAME_KEY = 'OpenTron-display-name';
const OPTIN_EMAIL_KEY = 'OpenTron-email';
const OPTIN_ANONID_KEY = 'OpenTron-anon-id';
const OPTIN_SEEN_KEY = 'OpenTron-optin-seen';
...
interface Settings {
  theme: ThemeMode;
  apiUrl: string;
  // Local server API key (OpenTron_API_KEY). Sent as a Bearer token on
  // /v1 + /api requests so a key-protected `Tron serve` doesn't 401 the
