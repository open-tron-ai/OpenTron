...
1. Browse the [Roadmap](https://open-Tron.github.io/OpenTron/development/roadmap/) for an item that interests you
2. Check if a [GitHub issue](https://github.com/open-Tron/OpenTron/issues) already exists for it — if not, [open one](https://github.com/open-Tron/OpenTron/issues/new/choose) describing what you'd like to work on
...
Use the appropriate [issue template](https://github.com/open-Tron/OpenTron/issues/new/choose):
...
OpenTron is built on five composable primitives. Here's where you can contribute:
